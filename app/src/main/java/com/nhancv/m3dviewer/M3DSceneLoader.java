...
public class M3DSceneLoader implements LoaderTask.Callback {
    ...
    public M3DSceneLoader(Activity main) {
        this.parent = main;
    }

    public void init(Uri uri, int modelType, M3DSurfaceView glSurfaceView) {
        this.glSurfaceView = glSurfaceView;
        // Camera to show a point of view
        camera = this.glSurfaceView.getCamera();
    ...
    public void processTouch(float x, float y) {
        M3DRenderer mr = glSurfaceView.getModelRenderer();
